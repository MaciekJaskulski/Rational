...
export const STEPS = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        points: 1,
        gridSize: "10-Grid",
        factBubble: "The 10-Grid measures 33½\"W × 33⅛\"D × 41⅞\"H, weighs about 287 lb, and runs on 18.9 kW — holding ten 1/1 GN pans. It's the same footprint as the 6-Grid, just taller, so it's still a straightforward swap-in if you're sizing up later. Cabinet and capacity are identical between Classic and Pro at this size; the difference is entirely in the controls.",
      ...
      },
      {
        ...
        factBubble: "The 20-Grid is 34½\"W × 35⅞\"D × 73¾\"H, around 560 lb, and pulls 37.2 kW — holding twenty 1/1 GN pans on a mobile rack, floor-standing only. At this volume most operators either run one near capacity or add a second unit as backup; either way, cabinet and capacity are identical between Classic and Pro at this size.",
        citation: { label: "RATIONAL iCombi Pro 20-Grid Datasheet", url: "https://cdn.beedash.com/Rational/987b9baeaccba945d161d25270667b610a71be6c.pdf" },
        suggestions: [
