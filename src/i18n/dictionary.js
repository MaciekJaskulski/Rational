...
export const DE = {
  ...
  // ---- XS add-on subflow ("Step 1a/1b/1c") ----
  "ADD-ONS": "ZUBEHÖR",
  "That's a great choice for a smaller volume, let's make sure it's suitable.":
  ...
  "Imagine roasting 20–30 chickens or a large batch of ribs. Fat and cooking juices accumulate during the cooking process. The integrated drain allows them to be removed from the cooking chamber rather than having to deal with them manually.":
    "Stellen Sie sich vor, Sie braten 20–30 Hähnchen oder eine große Charge Rippchen. Fett und Bratensaft sammeln sich während des Garvorgangs an. Der integrierte Ablauf entfernt sie direkt aus dem Garraum, statt dass Sie sie manuell entsorgen müssen.",
  "What if I mostly do vegetables?": "Was, wenn ich hauptsächlich Gemüse zubereite?",
  "Can I buy it as an add-on later on?": "Kann ich es später als Zubehör nachrüsten?",
  "This oven doesn't have an integrated fat drain, which is highly useful for large quantities of fatty food, and we advise selecting iCombi 6 1/1 that has that feature.":
    "Dieses Gerät hat keinen integrierten Fettablauf, der bei großen Mengen fetthaltiger Speisen sehr nützlich ist — wir empfehlen das iCombi 6 1/1, das diese Funktion bietet.",

  "STEP 1b OF 6 — CORE TEMPERATURE": "SCHRITT 1b VON 6 — KERNTEMPERATUR",
  "Do you need to measure the temperature inside the food? (Especially useful for whole chickens, pork, roast beef, etc.)":
    "Müssen Sie die Temperatur im Inneren der Speise messen? (Besonders nützlich bei ganzen Hähnchen, Schweinefleisch, Roastbeef usw.)",
  'The probe measures the temperature inside the food, rather than simply measuring the temperature of the oven chamber. You can tell the oven "Cook it until the core reaches X degrees."':
    "Der Fühler misst die Temperatur im Inneren der Speise statt nur der Temperatur im Garraum. Sie können dem Gerät sagen: 'Garen, bis der Kern X Grad erreicht.'",
  "How's that different to cooking by time?": "Was ist der Unterschied zum Garen nach Zeit?",
  "This oven doesn't have an external core probe that gives much more control over the final result if you cook large portions of meat, and we advise selecting iCombi 6 1/1 that has that feature.":
    "Dieses Gerät hat keinen externen Kernfühler, der bei großen Fleischportionen wesentlich mehr Kontrolle über das Ergebnis bietet — wir empfehlen das iCombi 6 1/1, das diese Funktion bietet.",

  "STEP 1c OF 6 — PANEL SECURITY": "SCHRITT 1c VON 6 — BEDIENFELDSICHERHEIT",
  "Will the oven be accessible to people who shouldn't be able to operate it?": "Haben auch Personen Zugang zum Gerät, die es nicht bedienen sollten?",
  "This is simply a physical/software lock for the control panel.": "Das ist einfach eine physische/softwareseitige Sperre für das Bedienfeld.",
  "How do I unlock the panel?": "Wie entsperre ich das Bedienfeld?",
